# Historico de Ideias de Video Enviadas - PBR Brazil

> Memoria anti-repeticao. O agente le este arquivo todo dia e NUNCA repete uma ideia
> ja listada aqui. Cada dia adiciona um bloco no fim (feito automaticamente).

## 2026-06-19
1. 8 segundos que valem o ano - Reel com hook de texto "espera os ultimos 3s", portao + montaria.
2. POV faltam 10s pra voce montar - Reel POV 1a pessoa, contagem regressiva e preparacao do peao.
3. Bastidores 2h antes do show PBR - mini vlog rapido de montagem de arena/equipe/animais.

## 2026-06-19
1. O touro que ninguém queria montar - Reel storytelling de vilão com texto na tela e abertura de portão
2. Nota 90+ ou nota zero — não tem meio-termo - Reel split-screen comparando montaria perfeita e queda relâmpago
3. O que o peão faz com as mãos nos 3s antes do portão abrir - Reel close-up câmera lenta nas mãos e corda, sem fala
